"""OpenRouter vision provider (M4 §9, §27-29).

OpenRouter is a routing layer; we always record the actual model identifier alongside
provider=openrouter (M4 §102). Inline data-URL images only; bounded requests.
"""
